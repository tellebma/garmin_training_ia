...
_BOUNDS_MIN: dict[tuple[str, str, str], tuple[int, int]] = {
    ...
    # côtes courtes / accélérations : accessibles à tous les niveaux, dans toutes
    # les phases (#165) — une séance courte, jamais un bloc de seuil.
    ("swim", "strides", "base"): (35, 50),
    ("swim", "strides", "build"): (40, 55),
    ("swim", "strides", "peak"): (30, 45),
    ...
    ("bike", "strides", "base"): (50, 75),
    ("bike", "strides", "build"): (55, 80),
    ("bike", "strides", "peak"): (45, 65),
    ...
    ("run", "strides", "base"): (35, 50),
    ("run", "strides", "build"): (40, 60),
    ("run", "strides", "peak"): (30, 45),
    ("run", "pma", "build"): (40, 55),
    ("run", "pma", "peak"): (35, 50),
