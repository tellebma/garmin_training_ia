...
class Settings(BaseSettings):
    ...
    # gpt-5.4-mini corrigeait le problème mais coûte ~6,5x plus cher par génération.
    # gpt-5.6-luna est la génération suivante à ~3,75x moins cher que gpt-5.4-mini.
